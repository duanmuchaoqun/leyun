...
(function (factory) {
    ...
    //dom渲染
    domDate = '<div id="date-wrapper"><h3>出生日期</h3><div id="d-content"><div id="d-tit"><div class="t1">年</div><div class="t2">月</div><div class="t3">日</div><div class="t4">时</div><div class="t5">分</div><div class="t6">秒</div></div><div id="d-bg"><ol id="d-year"></ol><ol id="d-month"></ol><ol id="d-day"></ol><ol id="d-hours"></ol><ol id="d-minutes"></ol><ol id="d-seconds"></ol></div></div><a id="d-cancel" href="javascript:">取消</a><a id="d-confirm" href="javascript:">确定</a></div><div id="d-mask"></div>';
    
    if(isEnglish){
        domDate = domDate.replace('出生日期','DatePicker').replace('取消','cancel').replace('确定','confirm');
